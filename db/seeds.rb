user = User.new(first_name: 'Bob', last_name: 'Ross', email: "bob@Ross.com", address: '2340 Telegraph Avenue', city: 'Berkeley', state: 'CA', zip_code: '94704')
user.save
...
petition = Document.new(name: 'Testing NDA')
